% MATLAB File : eno_stencil_interval_periodic.m
% [stencil,{stencil_periodicity,r}] = EnoStencilIntervalPeriodic(x,y,interval,{k=3})
%
% * Creation Date : 2009-06-04
%
% * Last Modified : Fri 12 Jun 2009 03:02:21 PM EDT
%
...
%   the least oscillatory stencil for k-th order interpolation. k must be
%   greater than 0. interval is a 2-vector specifying the periodicity of the
%   interval. If x is of length N, the returned matrix has N stencil
%   indicators: one for each interval of reconstruction between the points. 
%
%   [x(1), x(2)] <---> stencil(1,;)
%   [x(2), x(3)] <---> stencil(2,:)
%                  .
...
function[stencil,varargout] = eno_stencil_interval_periodic(x,y,interval,varargin)
